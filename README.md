...
Lumen Drift is a zero-dependency Canvas webgame about holding a signal route open for 90 seconds. It has keyboard, pointer, and touch input; score persistence; daily seeded routes; rotating objectives; difficulty modes; deterministic gameplay logic; offline app-shell caching; and a GitHub Pages deployment workflow.
